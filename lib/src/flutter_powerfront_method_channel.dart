...
class MethodChannelFlutterPowerfront extends FlutterPowerfrontPlatform {
  ...
  Future<void> pushView() async {
    await methodChannel.invokeMethod<bool>('pushView');
  }
  ...
  Future<void> presentView() async {
    await methodChannel.invokeMethod<bool>('presentView');
  }
  ...
  Future<void> _handleOnChatMessage(MethodCall call) async {
    try {
      ...
      final proactiveChat = bool.tryParse(args["proactiveChat"].toString()) == true;
